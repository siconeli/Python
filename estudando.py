...
#----------------------------------------------------
#Importando biblioteca com FROM:
...
# consseno = math.cos(ang)
# seno = math.sin(ang)
# tangente = math.tan(ang)

# print(f'Cosseno: {consseno}, Seno: {seno} e Tangente: {tangente}')

#----------------------------------------------------
#Sortear 1 entre 3 nomes informados:
# from random import choice

# a1 = input('Qual o seu nome? ')
# a2 = input('Qual o seu nome? ')
# a3 = input('Qual o seu nome? ')
...
#----------------------------------------------------
#Ler 3 nomes e mostrar a ordem de sorteio dos nomes para apresentação de um trabalho:
...
#----------------------------------------------------
#Encontrar em que posição inicia a frase ou letra que está buscando:

# texto = 'em qual posição'

# print(texto.find('posição'))

#----------------------------------------------------
#Usando IN para confirmar existência de string dentro de frase:
...
#----------------------------------------------------
#Substituir palavras dentro de uma string

# frase = 'Henrique Siconeli Francisco'

# print(frase.replace('Francisco', 'teste'))

#----------------------------------------------------
#Todas as letras de uma frase em minúsculo:
...
#----------------------------------------------------
#Todas as letras de uma frase em maiúsculo
...
#----------------------------------------------------
#Deixar a primeira letra da frase em maiúsculo
# frase = 'henrique siconeli francisco'

# print(frase.capitalize())

#----------------------------------------------------
#Deixar a primeira letra de todas as palavras da frase em maiúsculo
# frase = 'henrique siconeli francisco'
